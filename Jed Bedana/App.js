...
const App = () => {
  ...
  const data = {
    imageUrl: require('./assets/Jed.jpg'),
    name: 'Jed N. Bedana',
    course: 'Bachelor of Science in Information Technology',
    education: {
      elementary: 'Rincon Elementary School',
      elementaryYear: '2015',
      highSchool: 'Dalandanan National High School',
      highSchoolYear: '2019',
      seniorhighschool: 'Dalandanan National High School',
      seniorhighschoolYear: '2021',
      college: 'Global Reciprocal Colleges',
      collegeyear: '2025'
    },
    about: 'im jed bedana, im 20 years old and im currently schooling at global reciprocal college  and im 3rd year right now.',
    hobby:
    {
      hobbyName: 'Mobile Legends Bang Bang',
      imageSrc: require('./assets/ML.jpg'),
    },
    contact:
    {
      email: 'arthursjohnson0943@gmail.com',
      contact: '09482341745'
    }
        ...
        <TouchableOpacity onPress={handlePress} style={styles.mainContainer}>
          ...
          {currentSection === 'contact' && (
            <View>
               ...
               <Text style={styles.textBody}>bedanajed1@gmail.com</Text>
               <Text style={styles.textBodySubtle}>Contact Number:</Text>
               <Text style={styles.textBody}>09084939085</Text>
            </View>
          )}
